...
import com.viztushar.ERShare.dialog.ShareAppDialog;
import com.viztushar.ERShare.fragment.HomeFragment;
...
//            try {
//                startActivity(new Intent(this, Class.forName("com.viztushar.ERShare.activity.DonationActivity")));
