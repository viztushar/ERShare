...
import com.viztushar.ERShare.task.OrganizeShareRunningTask;
        ...
        implements SnackbarSupport, Activity.OnPreloadArgumentWatcher, WorkerService.OnAttachListener
{
    ...
    public static final String ACTION_SEND = "viztushar.intent.action.ershare_SEND";
    public static final String ACTION_SEND_MULTIPLE = "viztushar.intent.action.ershare_SEND_MULTIPLE";
