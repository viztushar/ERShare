package com.viztushar.ERShare.service;
...
import com.viztushar.ERShare.app.Service;
import com.viztushar.ERShare.config.AppConfig;
import com.viztushar.ERShare.config.Keyword;
import com.viztushar.ERShare.database.AccessDatabase;
import com.viztushar.ERShare.exception.AssigneeNotFoundException;
import com.viztushar.ERShare.exception.ConnectionNotFoundException;
import com.viztushar.ERShare.exception.DeviceNotFoundException;
import com.viztushar.ERShare.exception.TransferGroupNotFoundException;
import com.viztushar.ERShare.fragment.FileListFragment;
import com.viztushar.ERShare.object.NetworkDevice;
import com.viztushar.ERShare.object.TextStreamObject;
import com.viztushar.ERShare.object.TransferGroup;
import com.viztushar.ERShare.object.TransferInstance;
import com.viztushar.ERShare.object.TransferObject;
import com.viztushar.ERShare.util.AppUtils;
import com.viztushar.ERShare.util.CommunicationBridge;
import com.viztushar.ERShare.util.CommunicationNotificationHelper;
import com.viztushar.ERShare.util.DynamicNotification;
import com.viztushar.ERShare.util.FileUtils;
import com.viztushar.ERShare.util.HotspotUtils;
import com.viztushar.ERShare.util.NetworkDeviceLoader;
import com.viztushar.ERShare.util.NetworkUtils;
import com.viztushar.ERShare.util.NotificationUtils;
import com.viztushar.ERShare.util.NsdDiscovery;
import com.viztushar.ERShare.util.TimeUtils;
import com.viztushar.ERShare.util.TransferUtils;
import com.viztushar.ERShare.util.UpdateUtils;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.viztushar.ershare.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.viztushar.ershare.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.viztushar.ershare.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.viztushar.ershare.action.IP";
    public static final String ACTION_END_SESSION = "com.viztushar.ershare.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.viztushar.ershare.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.viztushar.ershare.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.viztushar.ershare.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.viztushar.ershare.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.viztushar.ershare.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.viztushar.ershare.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.viztushar.ershare.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.viztushar.ershare.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.viztushar.ershare.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.viztushar.ershare.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.viztushar.ershare.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.viztushar.ershare.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.viztushar.ershare.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.viztushar.ershare.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.viztushar.ershare.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.viztushar.ershare.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.viztushar.ershare.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.viztushar.ershare.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.viztushar.ershare.transaction.action.REQUEST_WEBSHARE_STATUS";
