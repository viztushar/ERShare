package com.viztushar.ERShare.config;
...
public class AppConfig
{
    ...
    public final static String
            EMAIL_DEVELOPER = "apps.cedr1k@gmail.com",
            URI_REPO_APP_UPDATE = "https://api.github.com/repos/genonbeta/ershare/releases",
            URI_REPO_APP_CONTRIBUTORS = "https://api.github.com/repos/genonbeta/ershare/contributors",
            URI_GOOGLE_PLAY = "https://play.google.com/store/apps/details?id=com.viztushar.ERShare",
            URI_REPO_APP = "http://github.com/genonbeta/ershare",
            URI_REPO_ORG = "http://github.com/genonbeta",
            URI_GITHUB_PROFILE = "https://github.com/%s",
            URI_TRANSLATE = "https://github.com/genonbeta/ershare/wiki/Language-contribution",
            URI_TELEGRAM_CHANNEL = "https://t.me/ershare",
            PREFIX_ACCESS_POINT = "TS_",
            EXT_FILE_PART = "tshare",
            NETWORK_INTERFACE_WIFI = "wlan0",
            NDS_COMM_SERVICE_NAME = "ERShare",
