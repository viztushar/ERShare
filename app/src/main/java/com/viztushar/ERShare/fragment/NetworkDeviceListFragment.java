package com.viztushar.ERShare.fragment;
...
import com.viztushar.ERShare.activity.ConnectionManagerActivity;
import com.viztushar.ERShare.dialog.EstablishConnectionDialog;
import com.viztushar.ERShare.adapter.NetworkDeviceListAdapter;
import com.viztushar.ERShare.app.EditableListFragment;
import com.viztushar.ERShare.callback.OnDeviceSelectedListener;
import com.viztushar.ERShare.config.AppConfig;
import com.viztushar.ERShare.database.AccessDatabase;
import com.viztushar.ERShare.dialog.DeviceInfoDialog;
import com.viztushar.ERShare.object.NetworkDevice;
import com.viztushar.ERShare.service.DeviceScannerService;
import com.viztushar.ERShare.ui.UIConnectionUtils;
import com.viztushar.ERShare.ui.callback.DetachListener;
import com.viztushar.ERShare.ui.callback.IconSupport;
import com.viztushar.ERShare.ui.callback.NetworkDeviceSelectedListener;
import com.viztushar.ERShare.ui.callback.TitleSupport;
import com.viztushar.ERShare.util.AppUtils;
import com.viztushar.ERShare.util.ConnectionUtils;
        ...
        implements TitleSupport, DetachListener, IconSupport, ConnectionManagerActivity.DeviceSelectionSupport
{
    ...
    private void openInfo(NetworkDevice device)
    {
        if (device instanceof NetworkDeviceListAdapter.HotspotNetwork) {
            ...
            builder.setMessage(R.string.text_ERShareHotspotDescription);
