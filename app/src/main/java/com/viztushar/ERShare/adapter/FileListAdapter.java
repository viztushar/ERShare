package com.viztushar.ERShare.adapter;
...
import com.viztushar.ERShare.GlideApp;
...
import com.viztushar.ERShare.util.MimeIconUtils;
        ...
        implements GroupEditableListAdapter.GroupLister.CustomGroupLister<FileListAdapter.GenericFileHolder>
{
    ...
    protected void onLoad(GroupLister<GenericFileHolder> lister)
    {
        ...
        if (path != null) {
            ...
            lister.offerObliged(this, new DirectoryHolder(defaultFolder, getContext().getString(R.string.text_receivedFiles), R.drawable.ic_ershare_rounded_white_24dp_static));
