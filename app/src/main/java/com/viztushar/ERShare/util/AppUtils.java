...
import com.viztushar.ERShare.App;
import com.viztushar.ERShare.BuildConfig;
import com.viztushar.ERShare.R;
import com.viztushar.ERShare.activity.WebShareActivity;
...
import com.viztushar.ERShare.graphics.drawable.TextDrawable;
...
public class AppUtils
{
    ...
    public static DocumentFile createLog(Context context)
    {
        ...
        String fileName = FileUtils.getUniqueFileName(saveDirectory, "ershare_log.txt", true);
